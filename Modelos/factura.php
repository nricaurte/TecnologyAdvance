...
foreach ($datos as $llave => $producto) {
  ...
  $this->consulta5="INSERT INTO inventarios VALUES ('','".$producto[1]."','venta','$f','".($producto[5]/$producto[3])."','0','0','".$producto[3]."','".(($producto[5]*$producto[3])/$producto[3])."','".($sum-$producto[3])."','".($producto[5]/$producto[3])."','".(($sum-$producto[3])*($producto[5]/$producto[3]))."')";
