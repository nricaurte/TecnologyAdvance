...
switch ($URI[0]) {
	...
	//Inicion about us contacto redireciones
        ...
        case '/TecnologyAdvance/index.php/aboutus':
			  require "Plantillas/about.php";
		break;
		 case '/TecnologyAdvance/index.php/inicio':
			  require "Plantillas/inicio.php";
		break;

		case '/TecnologyAdvance/index.php/contacto':
...
///////////////////////PRODUCTOS
		...
		break;
		case '/TecnologyAdvance/index.php/nuevo_pedido':
	       $controlador->nuevo_pedido_action();
		break;
//////////////////////FACTURA
